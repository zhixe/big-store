...
# WINDOWS
# log_file = f"C:\Users\datamicron\Documents\vscode\house_pricing\logs\log_PROD_staging_preprocessing_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"

# WSL
log_file = f"/mnt/c/Users/datamicron/Documents/Project/big_store/logs/log_PROD_staging_preprocessing_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
